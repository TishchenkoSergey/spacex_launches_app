...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [inter24ptRegular];
}
...
class $AssetsImagesLogoGen {
  ...
  /// File path: assets/images/logo/android12logo.png
  AssetGenImage get android12logo =>
      const AssetGenImage('assets/images/logo/android12logo.png');

  /// File path: assets/images/logo/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/images/logo/logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [android12logo, logo];
}
